...
class NewMNISTEnvironment(BaseEnvironment):
    """
    ...
    def duplicate(self) -> NewMNISTEnvironment:
        """
        @return: New instance of the XOR environment with identical parameters
        """
        if hasattr(self, 'epochs'):
            return NewMNISTEnvironment(True, verbosity=self.verbosity, epochs=self.epochs, batch_size=self.batch_size)
        else:
            return NewMNISTEnvironment(False, verbosity=self.verbosity)
